...
class person_info {
  ...
  static datatype() {
    ...
    return 'find_person/person_info';
  }

  static md5sum() {
    //Returns md5sum for a message object
    return '6a961519893f7b5c9a396afc5b003835';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new person_info(null);
