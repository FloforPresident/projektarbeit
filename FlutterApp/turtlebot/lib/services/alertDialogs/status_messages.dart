...
class StatusMessages
{
  ...
  {
    BasicAlertDialog.basicAlertDialog(context: context, title: Text("Ip-Adresse wurde geändert",style: TextStyle(color: _generalHeadlineColor)), content: [Text("Die IP-Addresse wurde erfolgreich geändert",style: TextStyle(fontSize: _fontsize))],
        actions:[ FlatButton(
            onPressed: () {
